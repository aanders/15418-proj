...
plot( ...
    ...
    lengths, RBOps(v9&mem&buniform&d5ms), ...
    lengths, ATOps(v4&mem&buniform&d5ms)  ...
);
...
plot( ...
    ...
    lengths, RBOps(v9&mem&blookup&d5ms), ...
    lengths, ATOps(v4&mem&blookup&d5ms)  ...
);
...
plot( ...
    ...
    lengths, RBOps(v9&mem&binsert&d5ms), ...
    lengths, ATOps(v4&mem&binsert&d5ms)  ...
);
...
plot( ...
    ...
    lengths, RBOps(v9&mem&bburst&d5ms), ...
    lengths, ATOps(v4&mem&bburst&d5ms)  ...
);
...
figure;
plot( ...
    lengths, SCInsert(v9&mem&buniform&d5ms), ...
    lengths, RBInsert(v9&mem&buniform&d5ms), ...
    lengths, ATInsert(v4&mem&buniform&d5ms)  ...
);
...
figure;
plot( ...
    lengths, SCInsert(v9&mem&blookup&d5ms), ...
    lengths, RBInsert(v9&mem&blookup&d5ms), ...
    lengths, ATInsert(v4&mem&blookup&d5ms)  ...
);
...
figure;
plot( ...
    lengths, SCInsert(v9&mem&binsert&d5ms), ...
    lengths, RBInsert(v9&mem&binsert&d5ms), ...
    lengths, ATInsert(v4&mem&binsert&d5ms)  ...
);
...
figure;
plot( ...
    lengths, SCInsert(v9&mem&bburst&d5ms), ...
    lengths, RBInsert(v9&mem&bburst&d5ms), ...
    lengths, ATInsert(v4&mem&bburst&d5ms)  ...
);
...
figure;
plot( ...
    lengths, SCLookup(v9&mem&buniform&d5ms), ...
    lengths, RBLookup(v9&mem&buniform&d5ms), ...
    lengths, ATLookup(v4&mem&buniform&d5ms)  ...
);
...
figure;
plot( ...
    lengths, SCLookup(v9&mem&blookup&d5ms), ...
    lengths, RBLookup(v9&mem&blookup&d5ms), ...
    lengths, ATLookup(v4&mem&blookup&d5ms)  ...
);
...
figure;
plot( ...
    lengths, SCLookup(v9&mem&binsert&d5ms), ...
    lengths, RBLookup(v9&mem&binsert&d5ms), ...
    lengths, ATLookup(v4&mem&binsert&d5ms)  ...
);
...
figure;
plot( ...
    lengths, SCLookup(v9&mem&bburst&d5ms), ...
    lengths, RBLookup(v9&mem&bburst&d5ms), ...
    lengths, ATLookup(v4&mem&bburst&d5ms)  ...
);
...
figure;
plot( ...
    lengths, SCDelete(v9&mem&buniform&d5ms), ...
    lengths, RBDelete(v9&mem&buniform&d5ms), ...
    lengths, ATDelete(v4&mem&buniform&d5ms)  ...
);
...
figure;
plot( ...
    lengths, SCDelete(v9&mem&blookup&d5ms), ...
    lengths, RBDelete(v9&mem&blookup&d5ms), ...
    lengths, ATDelete(v4&mem&blookup&d5ms)  ...
);
...
figure;
plot( ...
    lengths, SCDelete(v9&mem&binsert&d5ms), ...
    lengths, RBDelete(v9&mem&binsert&d5ms), ...
    lengths, ATDelete(v4&mem&binsert&d5ms)  ...
);
...
figure;
plot( ...
    lengths, SCDelete(v9&mem&bburst&d5ms), ...
    lengths, RBDelete(v9&mem&bburst&d5ms), ...
    lengths, ATDelete(v4&mem&bburst&d5ms)  ...
);
