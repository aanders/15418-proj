...
%% [V9 Disk 1ms] INSERT time vs Trace Len for Trace Bias
figure;
subplot(2,2,1);
plot( ...
    lengths, SCInsert(v9&disk&buniform&d1ms), ...
    lengths, RBInsert(v9&disk&buniform&d1ms), ...
    lengths, ATInsert(v4&disk&buniform&d1ms)  ...
);
title('Uniform trace bias');
legend('SortedCollection', 'Sequential Tree', 'Async Tree');
...
subplot(2,2,2);
plot( ...
    lengths, SCInsert(v9&disk&blookup&d1ms), ...
    lengths, RBInsert(v9&disk&blookup&d1ms), ...
    lengths, ATInsert(v4&disk&blookup&d1ms)  ...
);
title('Lookup trace bias');
legend('SortedCollection', 'Sequential Tree', 'Async Tree');
ylabel('Avg insert time (ms)');
...
subplot(2,2,3);
plot( ...
    lengths, SCInsert(v9&disk&binsert&d1ms), ...
    lengths, RBInsert(v9&disk&binsert&d1ms), ...
    lengths, ATInsert(v4&disk&binsert&d1ms)  ...
);
title('Insert trace bias');
legend('SortedCollection', 'Sequential Tree', 'Async Tree');
ylabel('Avg insert time (ms)');
...
subplot(2,2,4);
plot( ...
    lengths, SCInsert(v9&disk&bburst&d1ms), ...
    lengths, RBInsert(v9&disk&bburst&d1ms), ...
    lengths, ATInsert(v4&disk&bburst&d1ms)  ...
);
title('Flip trace bias');
legend('SortedCollection', 'Sequential Tree', 'Async Tree');
ylabel('Avg insert time (ms)');
...
%% [V9 Disk 1ms] DELETE time vs Trace Len for Trace Bias
figure;
subplot(2,2,1);
plot( ...
    lengths, SCDelete(v9&disk&buniform&d1ms), ...
    lengths, RBDelete(v9&disk&buniform&d1ms), ...
    lengths, ATDelete(v4&disk&buniform&d1ms)  ...
);
title('Uniform trace bias');
legend('SortedCollection', 'Sequential Tree', 'Async Tree');
...
subplot(2,2,2);
plot( ...
    lengths, SCDelete(v9&disk&blookup&d1ms), ...
    lengths, RBDelete(v9&disk&blookup&d1ms), ...
    lengths, ATDelete(v4&disk&blookup&d1ms)  ...
);
title('Lookup trace bias');
legend('SortedCollection', 'Sequential Tree', 'Async Tree');
ylabel('Avg delete time (ms)');
...
subplot(2,2,3);
plot( ...
    lengths, SCDelete(v9&disk&binsert&d1ms), ...
    lengths, RBDelete(v9&disk&binsert&d1ms), ...
    lengths, ATDelete(v4&disk&binsert&d1ms)  ...
);
title('Insert trace bias');
legend('SortedCollection', 'Sequential Tree', 'Async Tree');
ylabel('Avg delete time (ms)');
...
subplot(2,2,4);
plot( ...
    lengths, SCDelete(v9&disk&bburst&d1ms), ...
    lengths, RBDelete(v9&disk&bburst&d1ms), ...
    lengths, ATDelete(v4&disk&bburst&d1ms)  ...
);
title('Flip trace bias');
legend('SortedCollection', 'Sequential Tree', 'Async Tree');
ylabel('Avg delete time (ms)');
...
subplot(2,2,1);
plot( ...
    lengths, SCOps(v8&disk&buniform&d1ms), ...
    lengths, SCOps(v9&disk&buniform&d1ms)  ...
);
title('Uniform trace bias');
...
subplot(2,2,2);
plot( ...
    lengths, SCOps(v8&disk&blookup&d1ms), ...
    lengths, SCOps(v9&disk&blookup&d1ms)  ...
);
title('Lookup trace bias');
legend('CustomArrayV8', 'CustomArrayV9');
ylabel('Total op time (ms)');
...
subplot(2,2,3);
plot( ...
    lengths, SCOps(v8&disk&binsert&d1ms), ...
    lengths, SCOps(v9&disk&binsert&d1ms)  ...
);
title('Insert trace bias');
legend('CustomArrayV8', 'CustomArrayV9');
ylabel('Total op time (ms)');
...
subplot(2,2,4);
plot( ...
    lengths, SCOps(v8&disk&bburst&d1ms), ...
    lengths, SCOps(v9&disk&bburst&d1ms)  ...
);
title('Flip trace bias');
legend('CustomArrayV8', 'CustomArrayV9');
ylabel('Total op time (ms)');
